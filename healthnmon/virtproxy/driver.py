...
LOG = logging.getLogger('healthnmon.virtproxy.driver')
driver_opts = [
    cfg.StrOpt(
        'healthnmon_inventory_manager',
        default='healthnmon.virtproxy.inventory_manager.InventoryManager',
...
class Healthnmon(object):
    ...
    def __init__(self, host=None):
        self.host_name = host
        self.inventory_manager = importutils.\
            import_object(CONF.healthnmon_inventory_manager,
                          host=self.host_name)
